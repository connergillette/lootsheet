      ...
      <div className="flex justify-end align-middle gap-2 grow py-2">
        {
          !session && (
            <>
              <a href="/login"><div className={`hover:bg-gray-100 rounded-md px-4 py-2 transition h-min relative`} data-gktag="gk-01-01">Log in</div></a>
              <a href="/register"><div className={`hover:bg-yellow-300 bg-yellow-400 hover:text-gray-800 text-gray-900 rounded-md px-4 py-2 transition h-min font-bold relative`} data-gktag="gk-02-01">Sign up</div></a>
            </>
          )
        }
        {
